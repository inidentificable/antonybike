...
<div class="container">
  <table align="center" style="text-align:center;">
    <div class="span3">
      <div class="well sidebar-nav">
        <ul class="nav nav-list">
          ...
          <li class="active"><a href="<?php echo $_SERVER['PHP_SELF']."?a=".VENDEDOR;?>enviadovendedor.php"> Enviados</a></li>
    ...
    <table class="table table-striped" style="width:70%; text-align:center;" align="center">
      <tr>
        <td><a class="btn btn-navbar" href="<?php echo $_SERVER['PHP_SELF']."?a=".VENDEDOR;?>msjnuevovendedor.php"><i class="icon-envelope"></i> Nuevo</a></td>
      </tr>
      <tr>
        <td>Emisor</td>
        <td>Tipo</td>
