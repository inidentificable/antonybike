    ...
    <div class="span3">
      <div class="well sidebar-nav">
        <ul class="nav nav-list">
          ...
          <li><a href="<?php echo $_SERVER['PHP_SELF']."?a=".PROFESOR;?>listadousuario.php">Todos</a></li>
          <li><a href="<?php echo $_SERVER['PHP_SELF']."?a=".PROFESOR;?>listadoadm.php">Administrador</a></li>
          <li><a href="<?php echo $_SERVER['PHP_SELF']."?a=".PROFESOR;?>listadovendedor.php">Profesor</a></li>
          <li><a href="<?php echo $_SERVER['PHP_SELF']."?a=".PROFESOR;?>listadovendedor.php">Vendedor</a></li>
          <li><a href="<?php echo $_SERVER['PHP_SELF']."?a=".PROFESOR;?>listadocliente.php">Alumnos</a></li>
        </ul>
      </div>
      <!--/.well --> 
    </div>
