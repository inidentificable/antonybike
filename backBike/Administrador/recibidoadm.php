    ...
    <div class="span3">
      <div class="well sidebar-nav">
        <ul class="nav nav-list">
          ...
          <li><a href="<?php echo $_SERVER['PHP_SELF']."?a=".ADMINISTRADOR;?>enviadoadm.php">Todos</a></li>
          <li><a href="<?php echo $_SERVER['PHP_SELF']."?a=".ADMINISTRADOR;?>enviadoadm.php">Enviados</a></li>
          <li class="active"><a href="<?php echo $_SERVER['PHP_SELF']."?a=".ADMINISTRADOR;?>recibidoadm.php">Recibidos</a></li>
        </ul>
      </div>
      <!--/.well --> 
    </div>
